...
def parseArgs():
    ...
    parser.add_argument("-mi", "--max-iter", type=int, default=1000, help="Max Iterations")
...
if __name__ == "__main__":
    ...
    for idx, item in enumerate(dataset):
        ...
        model = EffectModel(5, x_sr+1).to(device)
        ...
        for i in tqdm(range(args.max_iter)):
            ...
            writer.add_audio("{:02d}/processed".format(idx), new_x.squeeze(0).squeeze(0), i, sample_rate=x_sr)
